...
public class PickerOptions {
    ...
    public int textSizeContent = 22;//内容文字大小

    public int textColorOut = 0x33000000; //分割线以外的文字颜色
    public int textColorCenter = 0xFF000000; //分割线之间的文字颜色
    public int dividerColor = 0x00000000; //分割线的颜色
