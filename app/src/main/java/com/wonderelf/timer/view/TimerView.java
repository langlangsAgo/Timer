...
import com.wonderelf.timer.util.PxUtils;
...
public class TimerView extends View {
    ...
    public TimerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBigColor = a.getColor(R.styleable.CirclePercentView_bigColor, 0x80000000);
...
//        canvas.drawRoundRect(rect1, );
        ...
        RectF rect2 = new RectF(0, 0, mWidth, mHeight);

        canvas.drawArc(rect2, 270, mEndAngle, true, sectorPaint);
