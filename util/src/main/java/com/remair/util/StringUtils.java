...
public class StringUtils {
    ...
    * */
    ...
    public static String createTimeMillis() {
        return String.valueOf(System.currentTimeMillis());
    }

    public static String createTimeMillisInt() {
    ...
    public static String paresEndTime(long time) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        String format = dateFormat.format(time);
        return format;
    }

    public static String paresEndTimeDay(long time) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String format = dateFormat.format(time);
        return format;
    }

    public static String paresEndTimeShot(long time) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy.MM.dd");
        String format = dateFormat.format(time);
        return format;
    }
    ...
    public static boolean isLetterDigit(String str){
        ...
        boolean isDigit = pattern.matcher(str).matches(); //定义一个boolean值，用来表示是否包含数字

        String re = "^[a-zA-Z]+$";
        boolean isLetter = str.matches(re);

        String regex = "^[a-zA-Z0-9]+$";
        boolean isRight = str.matches(regex) || isDigit || isLetter;
        return isRight;
    }
