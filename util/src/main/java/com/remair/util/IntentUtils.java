...
public class IntentUtils {
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Uri contentUri = FileProvider.getUriForFile(ContextUtils
                    .getContext(), "com.wonderful.horse.fileProvider", file);
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return ContextUtils.getContext().getPackageManager()
