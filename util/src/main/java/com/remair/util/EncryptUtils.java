 ...
 * 类描述：
 * 创建人：LiuJun
 * 创建时间：2016/12/2 14:41
 * 修改人：LiuJun
 * 修改时间：2016/12/2 14:41
 * 修改备注：
 */
public class EncryptUtils {
    ...
    public static String encryptMD5ToString(String data, String salt) {
        return ConvertUtils
                .bytes2HexString(encryptMD5((data + salt).getBytes()));
    }
    ...
    public static String encryptMD5Str32(String str) {
    ...
    public static byte[] desTemplate(byte[] data, byte[] key, String algorithm, String transformation, boolean isEncrypt) {
        ...
        try {
            ...
            cipher.init(isEncrypt
                    ? Cipher.ENCRYPT_MODE
                    : Cipher.DECRYPT_MODE, keySpec, random);
